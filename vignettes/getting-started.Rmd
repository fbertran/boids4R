...
0.4.0 or later is installed, the optional adapter emphasizes current boids,
keeps recent positions as faint trails, colours species and explicit
prey/predator roles distinctly, draws velocity vectors in species colours by
default, and includes visible rings for obstacles and predator influence zones.
