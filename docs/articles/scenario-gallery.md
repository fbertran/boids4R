...
can be converted into a timeline-aware WebGL specification. The adapter
keeps current boids visually dominant, draws recent history as faint
trails, colours velocity vectors by species by default, and includes
visible rings for obstacles and predator influence zones. This step is
